...
\addto\captionsvietnamese{\renewcommand{\contentsname}{Table of Contents}}
...
\title{\Large IEEE-754 FP32 Cubic Equation Solver}
...
\include{contents/inter_imple}
\include{contents/simulation}
\include{contents/result_summary}
\include{contents/conformal}
\end{document}
